...
Write-Host "Beginning installation of spicetify-lightness"
Write-Host "https://github.com/lemonbigbig/spicetify-lightness"
...
$themePath = "$spicePath\Themes\lightness"
if (-not (Test-Path $themePath)) {
  Write-Host "Creating lightness theme folder..."
...
# Copy the lightness.js to the Extensions folder
Copy-Item lightness.js ..\..\Extensions
Write-Host "+ Installed lightness.js theme"
...
Write-Host "+ Configured lightness theme"
